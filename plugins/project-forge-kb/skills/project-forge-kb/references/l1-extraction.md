...
5. 子代理报告业务术语、观察到的行为、可能的规则与不变量、能力、边界、跨域关系、少量有效代码锚点，以及反直觉、高风险或无法解释的设计。子代理不得决定领域语义，也不得直接修改 L1、ADR 或 `.review`。
...
8. 将可复现证据写入 `docs/kb/.meta/L1/<domain_id>.json`：`source_commit`、范围快照、archive ID、观察到的锚点、推断候选和 ADR 引用。
